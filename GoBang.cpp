...
/*开始下棋*/
void GoBang::Play(operate & WZQ, GoBang & g)
{
...
/*玩家走*/
void GoBang::PlayChess(int player, int flag)
{
	/*初始化光标位置，定位（8，8）*/
	int X = 8 - 1;
	int Y = 8 - 1;
...
/*判断是否有玩家获胜（底层判断）*/
int GoBang::JudgeVictory(Position pos, int player)
{
	int begin = 0;
	int end = 0;
...
/*判断具体获胜玩家*/
bool GoBang::GetVictory(Position& pos, int player, int flag)
{
